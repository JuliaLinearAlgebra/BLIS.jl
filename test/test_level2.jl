...
@testset "BLAS level-2 LinearAlgebra interface" begin
    ...
    @test zrtest(reduce(max, @l2_test_evict BLAS.gemv!  100    Float32 ('N', αr, A, x, βr) ), 1e-6, "sgemv_n_100")
    ...
    @test zrtest(reduce(max, @l2_test_evict BLAS.symv!   32    Float32 ('U', αr, A, x, βr) ), 1e-5, "ssymv_u_32")
    ...
    @test zrtest(reduce(max, @l2_test_evict BLAS.trmv!   32    Float32 ('U', 'N', 'U', A) ), 1e-5, "strmv_u_32")
    ...
    @test zrtest(reduce(max, @l2r_test_evict BLAS.ger!  100    Float32    Float32 (αr, x, y) ), 1e-6, "sger_100")
    ...
    @test zrtest(reduce(max, @l2r_test_evict BLAS.syr!  100    Float32    Float32 ('U', αr, x) ), 1e-6, "ssyr_u_100")
